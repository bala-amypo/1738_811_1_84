Here are the entity files (models) for the project. These are designed with explicit Getter and Setter methods (as requested) and follow the exact field requirements and constraints mentioned in your problem statement.

1. Vehicle Entity

File: src/main/java/com/example/demo/model/Vehicle.java
...
File: src/main/java/com/example/demo/model/Garage.java
...
3. ServiceEntry Entity

File: src/main/java/com/example/demo/model/ServiceEntry.java
...
4. ServicePart Entity

File: src/main/java/com/example/demo/model/ServicePart.java
...
5. VerificationLog Entity

File: src/main/java/com/example/demo/model/VerificationLog.java
